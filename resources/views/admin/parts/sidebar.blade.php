<div class="app-sidebar">
    ...
    <div class="main-menu">
        ...
        <div class="pt-2 side-menu">
            ...
            <div class="slide animate-right px-2">
                <a @class(['side-menu__item has-link', 'active' => request()->routeIs('admin.recipe-item.*')])
                    data-bs-toggle="slide" href="{{ route('admin.recipe-item.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0 1 12 15a9.065 9.065 0 0 0-6.23-.693L5 14.5m14.8.8 1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0 1 12 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5" />
                    </svg>
                    <span class="side-menu__label">{{ __('portal.recipe_items') }}</span>
                </a>
            </div>

            <div class="slide animate-right px-2">
                <a @class(['side-menu__item has-link', 'active' => request()->routeIs('admin.requirement-report.*')])
                    data-bs-toggle="slide" href="{{ route('admin.requirement-report.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 17.25v1.007a3 3 0 0 1-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0 1 15 18.257V17.25m6-12V15a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 15V5.25m18 0A2.25 2.25 0 0 0 18.75 3H5.25A2.25 2.25 0 0 0 3 5.25m18 0V12a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 12V5.25" />
                    </svg>
                    <span class="side-menu__label">{{ __('portal.requirement_report') }}</span>
                </a>
            </div>
            ...
            <div class="slide animate-right px-2">
                <a @class(['side-menu__item has-link', 'active' => request()->routeIs('admin.monthly-payment.*')])
                    data-bs-toggle="slide" href="{{ route('admin.monthly-payment.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
                    </svg>
                    <span class="side-menu__label">{{ __('portal.monthly_payments') }}</span>
                </a>
            </div>
            ...
            <div class="slide animate-right px-2">
                <a @class(['side-menu__item has-link', 'active' => request()->routeIs('admin.user.*')])
                    ...
                    <span class="side-menu__label">{{ __('portal.users') }}</span>
                </a>
            </div>
            @endif
