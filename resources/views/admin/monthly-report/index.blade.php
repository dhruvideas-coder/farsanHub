...
<div class="row g-3 mb-3">
    ...
    {{-- CUSTOMER WISE BLANK PAYMENT SHEET (for the CA) --}}
    <div class="col-12 col-lg-4">
        <div class="card rpt-card">
            <div class="rpt-stripe"></div>
            <div class="rpt-head">
                <div class="rpt-icon"><i class="fa fa-pencil-square-o"></i></div>
                <div>
                    <p class="rpt-title">{{ trans('portal.customer_payment_sheet') }}</p>
                    <p class="rpt-sub">{{ __('portal.customer_payment_sheet_sub') }}</p>
                </div>
            </div>
            <hr class="rpt-divider">
            <div class="rpt-body">
                <form action="{{ route('admin.monthly-report.customer-payment-sheet') }}" method="GET">
                    <div class="mb-3">
                        <label class="rpt-label">{{ trans('portal.select_month_year') }}</label>
                        <select name="month_year" class="rpt-select">
                            <option value="">— {{ trans('portal.select_month_year') }} —</option>
                    ...
                    <p class="text-muted mb-3" style="font-size:0.82rem;">
                        {{ __('portal.customer_payment_sheet_desc') }}
                    </p>
                    <div class="rpt-btn-row">
                        <button type="submit" class="rpt-btn rpt-btn-pdf">
                            <i class="fa fa-file-pdf-o"></i> {{ @trans('portal.pdf') }}
